...
<urlset xmlns="http://www.sitemaps.org/schemas/sitemap/0.9">
  <url>
      <loc>https://sanjaikumar.vercel.app</loc>
  </url>
  <url>
      <loc>https://sanjaikumar.vercel.app/blog</loc>
  </url>
</urlset>
```
...
> **Note:** `globby` [might not work](https://github.com/sanjaikumar/sanjaikumar.vercel.app/issues/293) on Windows.
    ...
    <urlset xmlns="http://www.sitemaps.org/schemas/sitemap/0.9">
        ${pages
          .map((page) => {
            ...
            return `
              <url>
                  <loc>${`https://sanjaikumar.vercel.app${route}`}</loc>
              </url>
            `;
          })
          .join('')}
...
```bash
User-agent: *
Sitemap: https://sanjaikumar.vercel.app/sitemap.xml
```
